...
void forward_lstm_layer(layer l, NetworkState state)
{
  NetworkState s = {0};
  s.train = state.train;
...
void backward_lstm_layer(layer l, NetworkState state)
{
  NetworkState s = {0};
  s.train = state.train;
  s.workspace = state.workspace;
...
void forward_lstm_layer_gpu(layer l, NetworkState state)
{
  NetworkState s = {0};
  s.train = state.train;
  s.workspace = state.workspace;
...
void backward_lstm_layer_gpu(layer l, NetworkState state)
{
  NetworkState s = {0};
  s.train = state.train;
  s.workspace = state.workspace;
