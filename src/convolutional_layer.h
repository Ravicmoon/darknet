...
#endif
#ifdef GPU
void forward_convolutional_layer_gpu(
    convolutional_layer layer, NetworkState state);
void backward_convolutional_layer_gpu(
    convolutional_layer layer, NetworkState state);
void update_convolutional_layer_gpu(convolutional_layer layer, int batch,
    float learning_rate, float momentum, float decay, float loss_scale);
...
void backward_convolutional_layer(
    convolutional_layer layer, NetworkState state);
