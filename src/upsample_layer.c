...
void forward_upsample_layer(const layer l, NetworkState net)
{
...
void backward_upsample_layer(const layer l, NetworkState state)
{
  ...
  {
    upsample_cpu(
        state.delta, l.w, l.h, l.c, l.batch, l.stride, 0, l.scale, l.delta);
  }
}
...
void backward_upsample_layer_gpu(const layer l, NetworkState state)
{
  ...
  {
    upsample_gpu(
        state.delta, l.w, l.h, l.c, l.batch, l.stride, 0, l.scale, l.delta_gpu);
  }
}
#endif
