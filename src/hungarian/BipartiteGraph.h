...
public:
  ...
  std::vector<Vertex>* GetAgents(void){ return &agents; }
  std::vector<Vertex>* GetTasks(void){ return &tasks; }
  ...
  void DisplayLabels(std::vector<Vertex>& v);
  ...
  bool CheckFeasibility(Matrix&, std::vector<Vertex>&, std::vector<Vertex>&);
